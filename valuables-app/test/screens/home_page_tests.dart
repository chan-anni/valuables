...
import 'package:valuables/pages/home_page.dart';
  ...
  group('HomePage Widget Tests', () {
    ...
    testWidgets('HomePage displays welcome message', (
      ...
      expect(
        find.byWidgetPredicate(
          (widget) =>
              widget is Text && widget.data?.contains('Welcome') == true,
        ),
        findsOneWidget,
      );
    });
    ...
    testWidgets('Settings modal contains About Valuables information', (
      ...
      if (aboutButton.evaluate().isNotEmpty) {
        ...
        expect(find.text('About Valuables'), findsWidgets);
        expect(
          find.text('Valuables is a community-driven platform'),
          findsWidgets,
        );
      }
    });
    ...
    testWidgets('Refresh indicator is functional', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('Key section headers are displayed', (
      ...
      expect(
        find.text('Get notified when potential matches are found'),
        findsOneWidget,
      );
      expect(
        find.text('Keep track of items waiting to be claimed'),
        findsOneWidget,
      );
    });
